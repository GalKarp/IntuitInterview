...
public class DataAggregationController {
    ...
    @ApiOperation(value = "Get all Blue product data")
    @GetMapping("/getBlueData")
    public ResponseEntity<List<DataAggregation>> getBlueData(){
        try {
            log.info("Going to retrieve list of Blue products from CRM");
