...
@SpringBootTest(classes = BlueService.class)
@AutoConfigureMockMvc
public class BlueServiceTesting {
	...
	public void refreshDataIntervalTest()
		...
		assertFalse(checkingStringOnBlueData(jsonString));
	...
	private boolean checkingStringOnBlueData(String jsonString) throws Exception {
		return mvc.perform(get("/getBlueData")
	...
	private void gettingBlueData() throws Exception {
		mvc.perform(get("/getBlueData")
				.contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk())
				.andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON));
	}
